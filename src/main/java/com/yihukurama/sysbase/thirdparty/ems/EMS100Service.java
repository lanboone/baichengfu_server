package com.yihukurama.sysbase.thirdparty.ems;
 ...
 */
@Service
public class EMS100Service {

	public String searchEms(String com,String num){

		String phone = "13750085754";				//手机号码后四位
		String from = "";				//出发地
		String to = "";					//目的地
		int resultv2 = 0;				//开启行政规划解析

		String result = synQueryData(com, num, phone, from, to, resultv2);
		LogUtil.debugLog(this,"快递返回"+ JSON.toJSONString(result));
		return result;
	}
	...
	public String synQueryData(String com, String num, String phone, String from, String to, int resultv2) {
		...
		String key = "bTgfUbrf4019";				//贵司的授权key
		String customer = "BCA7CC45AF911846FA4E2828C32C579E";			//贵司的查询公司编号
