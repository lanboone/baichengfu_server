...
(
    ...
    `standard_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci     DEFAULT NULL COMMENT '父规格名称,如 颜色',
...
(
    `id`           varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL COMMENT '主键',
    `product_id`   varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci      DEFAULT NULL COMMENT '商品id',
    `compose`      varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci     DEFAULT NULL COMMENT '子规格组合,分号分割，如红色;20x20;A',
